...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(interface_Cmodules)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(interface_Cmodules)
ZEND_DECLARE_MODULE_GLOBALS(interface_Cmodules)
#define SWIG_ErrorMsg() (interface_Cmodules_globals.error_msg)
#define SWIG_ErrorCode() (interface_Cmodules_globals.error_code)
#ifdef __GNUC__
...
static void interface_Cmodules_init_globals(zend_interface_Cmodules_globals *globals ) {
...
ZEND_NAMED_FUNCTION(_wrap_swig_interface_Cmodules_alter_newobject) {
  zval args[2];
  swig_object_wrapper *value;
...
ZEND_NAMED_FUNCTION(_wrap_swig_interface_Cmodules_get_newobject) {
  zval args[1];
  swig_object_wrapper *value;
...
#define SWIG_name  "interface_Cmodules"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_interface_Cmodules.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_bubble_Sort) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of bubble_Sort. Expected SWIGTYPE_p_int");
  }
...
static zend_function_entry interface_Cmodules_functions[] = {
 SWIG_ZEND_NAMED_FE(factorial,_wrap_factorial,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(bubble_sort,_wrap_bubble_Sort,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(swig_interface_Cmodules_alter_newobject,_wrap_swig_interface_Cmodules_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_interface_Cmodules_get_newobject,_wrap_swig_interface_Cmodules_get_newobject,NULL)
 ZEND_FE_END
};

/* init section */
zend_module_entry interface_Cmodules_module_entry = {
    STANDARD_MODULE_HEADER,
    "interface_Cmodules",
    interface_Cmodules_functions,
    PHP_MINIT(interface_Cmodules),
...
zend_module_entry* SWIG_module_entry = &interface_Cmodules_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &interface_Cmodules_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(interface_Cmodules)
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(interface_Cmodules, interface_Cmodules_init_globals, NULL);
